<footer class="footer grid__container">
    <div class="footer__wrapper grid__item--4-12">
        ...
        <div class="footer__logo-container grid__item--3-3">
            <a title="Página Inicial" href="<?php echo home_url(); ?>">
        ...
        <adress class="footer__phones-container">
            <?php
                $addresses_data = get_field('footer__addresses', 6);
                $item_counter = 1;
                foreach( $addresses_data as $item ):
                    if( $item_counter == count($addresses_data) ):
            ?>
        </adress>
        <adress class="footer__adress-container">
            <?php endif; ?>
    ...
    <div class="footer__institutional grid__item--4-12">
        ...
        <div class="footer__institutional-social-container">
            ...
            <a title="Instagram Veros" href="https://www.instagram.com/veros.vet/" class="footer__institutional-social">
            ...
            <a title="LinkedIn Veros" href="https://www.linkedin.com/company/verosvet/" class="footer__institutional-social">
            ...
            <a title="Youtube Veros" href="https://www.youtube.com/@verosvet2343" class="footer__institutional-social">
