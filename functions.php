...
function veros_register_styles(){
    ...
    if (/*is_front_page() ||*/ is_page_template('internacao-uti.php') || is_page_template('cirurgias.php') || is_page_template('ps-ambulancia.php') || is_page_template('consultas.php') || is_page_template('exames.php') || is_page_template('para-vets.php') || is_page_template('post-veros.php') || is_page_template('trabalhe-conosco.php')){
    ...
    if (is_page_template('exames.php')){
        wp_enqueue_style('veros-exames', get_template_directory_uri() . '/assets/styles/css/exames.css', array('veros-normalize', 'veros-glide-core-style', 'veros-glide-theme-style'), $version);    
    }
    if (is_page_template('para-vets.php')){
        wp_enqueue_style('veros-para-vets', get_template_directory_uri() . '/assets/styles/css/para-vets.css', array('veros-normalize', 'veros-glide-core-style', 'veros-glide-theme-style'), $version);    
    }
    ...
    if (is_page_template('post-veros.php')){
        wp_enqueue_style('veros-post-veros', get_template_directory_uri() . '/assets/styles/css/post-veros.css', array('veros-normalize', 'veros-glide-core-style', 'veros-glide-theme-style'), $version);    
    }
    if (is_page_template('trabalhe-conosco.php')){
        wp_enqueue_style('veros-trabalhe-conosco', get_template_directory_uri() . '/assets/styles/css/trabalhe-conosco.css', array('veros-normalize', 'veros-glide-core-style', 'veros-glide-theme-style'), $version);    
    }
...
function veros_register_scripts(){
    ...
    if (is_page_template('exames.php')){
        wp_enqueue_script('veros-tabnav', get_template_directory_uri() . '/scripts/tabnav.js', array(), $version, true);
        wp_enqueue_script('veros-exames-glide', get_template_directory_uri() . '/scripts/exames__glide.js', array('veros-glide-cdn'), $version, true);
    }
    if (is_page_template('para-vets.php')){
        wp_enqueue_script('veros-social-proof-glide', get_template_directory_uri() . '/scripts/glide--social-proof.js', array('veros-glide-cdn'), $version, true);
    }
    if (is_page_template('post-veros.php')){
        wp_enqueue_script('veros-post-veros-glide', get_template_directory_uri() . '/scripts/post-veros__glide.js', array('veros-glide-cdn'), $version, true);
    }
    if (is_page_template('trabalhe-conosco.php')){
        wp_enqueue_script('veros-social-proof-glide', get_template_directory_uri() . '/scripts/glide--social-proof.js', array('veros-glide-cdn'), $version, true);
        wp_enqueue_script('veros-trabalhe-conosco-glide', get_template_directory_uri() . '/scripts/trabalhe-conosco__glide.js', array('veros-glide-cdn'), $version, true);
    }
