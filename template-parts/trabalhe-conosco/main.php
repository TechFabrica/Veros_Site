<section class="main grid__container">
    <h2 class="main__title grid__item--4-9"><?php the_field('main__title') ?></h2>
    <h2 class="main__subtitle grid__item--4-9"><?php the_field('main__subtitle') ?></h2>
    <div class="main__glide main-glide grid__item--4-12">
        <div class="main-glide__track" data-glide-el="track">
            <ul class="main-glide__slides">
                <?php
                    $cards_data = get_field('main__cards');
                    foreach($cards_data as $item):
                ?>
                <li class="main__card main-glide__slide">
                    <h4 class="main__card-title"><?php echo $item['main__card-title']; ?></h4>
                    <p class="main__card-location"><?php echo $item['main__card-location']; ?></p>
                    <p class="main__card-content"><?php echo $item['main__card-content']; ?></p>
                    <a href="<?php echo $item['main__card-link']; ?>" class="main__card-button button button--line button--round"><?php echo $item['main__card-link-text']; ?></a>
                </li>
                <?php endforeach; ?>
            </ul>
        </div>
        <div class="main-glide__arrows" data-glide-el="controls">
            <button aria-label="Anterior" class="main__glide-arrow main-glide__arrow main-glide__arrow--left" data-glide-dir="<">
            ...
            <button aria-label="Próximo" class="main__glide-arrow main-glide__arrow main-glide__arrow--right" data-glide-dir=">">
        ...
        <div class="main-glide__bullets" data-glide-el="controls[nav]">
            <?php
                $bullet_index = 0;
                foreach($cards_data as $item):
            ?>
            <button class="main-glide__bullet" data-glide-dir="=<?php echo $bullet_index ?>"></button>
            <?php
                $bullet_index++; 
                endforeach;
            ?>
